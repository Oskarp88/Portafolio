...
const Technologies = () => {
  const skills = [
    { year: 2022, src: javaScript, title: "JavaScript ES6", stars: 4 },
    { year: 2022, src: reactJS, title: "React JS", stars: 5 },
    { year: 2024, src: flutter, title: "Flutter", stars: 5 },
    { year: 2024, src: python, title: "Python", stars: 4 },
    { year: 2022, src: Redux, title: "Redux", stars: 5 },
    { year: 2022, src: Node, title: "Node.js", stars: 4 },
    { year: 2022, src: HTML, title: "HTML", stars: 5 },
    { year: 2023, src: css, title: "CSS", stars: 4 },
    { year: 2023, src: mongodb, title: "MongoDB", stars: 4 },
    { year: 2022, src: Postgres, title: "PostgreSQL", stars: 3.5 },
  ];
    ...
    <Timeline align="left" className={style.timeline}>
      {skills.map(({ year, src, title, stars }, index) => (
        <TimelineItem key={index}>
          <TimelineOppositeContent className={style.year}>
            <Typography variant="body2" color="textSecondary">
              {year}
            </Typography>
          </TimelineOppositeContent>
          <TimelineSeparator>
            <TimelineDot className={style.dot}>
              <img src={src} alt={title} className={style.customlogo} />
            </TimelineDot>
            {index !== skills.length - 1 && <TimelineConnector className={style.connector} />}
          </TimelineSeparator>
          <TimelineContent>
